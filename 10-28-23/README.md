...
#### Screenshots 📷:
![Screenshot of Java Online Compiler doing arithmetic in Java](screenshots/screenshot-one.png)
![Screenshot of Java Online Compiler using the Scanner class](screenshots/screenshot-two.png)
![Screenshot of calculator final activity](screenshots/screenshot-three.png)